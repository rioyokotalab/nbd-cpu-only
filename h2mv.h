...
namespace nbd {
  ...
  void closeQuarter(const Cells& icells, const Cells& jcells, const Matrices& d, const real_t* x, real_t* b);

  void h2mv_complete(const Cells& icells, const Cells& jcells, const Matrices& ibase, const Matrices& jbase, const Matrices& d, const real_t* x, real_t* b);
